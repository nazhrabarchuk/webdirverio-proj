...
export default class BasketAddressComponent {
  ...
  get continueButton () {
    return new Button($('button[aria-label="Proceed to payment selection"]'),
      'Proceed to payment selection игеещт')
  }

  get addressCountryInput () {
    return new Input($('input[data-placeholder="Please provide a country."]'),
      'Add new address country input')
  }

  get addressNameInput () {
    return new Input($('input[data-placeholder="Please provide a name."]'),
      'Add new address name input')
  }

  get addressMobileNumberInput () {
    return new Input($('input[data-placeholder="Please provide a mobile number."]'),
      'Add new address mobile number input')
  }

  get addressZipInput () {
    return new Input($('input[data-placeholder="Please provide a ZIP code."]'),
      'Add new address zip input')
  }
  ...
  get addressCityInput () {
    return new Input($('input[data-placeholder="Please provide a city."]'),
      'Add new address city input')
  }

  get addressStateInput () {
    return new Input($('input[data-placeholder="Please provide a state."]'),
      'Add new address state input')
  }
