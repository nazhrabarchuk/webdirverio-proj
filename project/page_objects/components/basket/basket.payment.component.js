...
export default class BasketPaymentComponent {
  ...
  get newCardNameInput () {
    return new Input($('//*[contains(text(),"Name")]/ancestor::div[contains(@class,"mat-form-field-infix")]/input'),
      'New card name input')
  }

  get newCardNumberInput () {
    return new Input(
      $('//*[contains(text(),"Card Number")]/ancestor::div[contains(@class,"mat-form-field-infix")]/input'),
      'New card number input')
  }

  get newCardExpiryMonthDropdown () {
    return new Dropdown(
      $('//*[contains(text(),"Expiry Month")]/ancestor::div[contains(@class,"mat-form-field-infix")]/select'),
      'New card expiry month dropdown')
  }

  get newCardExpiryYearDropdown () {
    return new Dropdown(
      $('//*[contains(text(),"Expiry Year")]/ancestor::div[contains(@class,"mat-form-field-infix")]/select'),
      'New card expiry year dropdown')
  }
