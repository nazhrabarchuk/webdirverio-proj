...
class BasketPage extends BasePage {
  ...
  get snackBar () {
    return new TextView($('//*[contains(text(),\'We are out of stock! Sorry for the inconvenience.\')]'),
      'SnackBar modal')
  }

  get plusItemButton () {
    return new Button($('.mat-icon-button.mat-button-base.ng-star-inserted:last-child'),
      'Plus count for item in basket')
  }
