...
import { addAllureStep } from '../../../framework/helpers/allure.wrapper.js'
...
class RegistrationPage extends BasePage {
  ...
  get errorEmailCo () {
    return new TextView($('//*[contains(@class,\'mat-error\') and contains(text(),\'Email address is not valid.\')]'),
      'Error email text')
  }

  get passNotMatchCo () {
    return new TextView($('//*[contains(@class,\'mat-error\') and contains(text(),\'Passwords do not match\')]'),
      'Error pass not match text')
  }
  ...
  async registration (email, pass, repeatPass, securityQuestion, securityAnswer) {
    addAllureStep('Set registration credentials')
